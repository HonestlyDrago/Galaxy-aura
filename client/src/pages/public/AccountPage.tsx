...
import { Package, Heart, Settings, LogOut, ArrowRight, Clock, Loader2 } from 'lucide-react'
  ...
  return (
    <PublicLayout cartCount={0}>
      <div className="container mx-auto px-4 py-8">
        {/* Welcome Section */}
        <div className="mb-8">
          <h1 className="text-4xl font-serif font-bold mb-2">Welcome Back, {user?.name || 'User'}</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6">
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-sm">{user?.address ? `${user.address}${user.city ? ', ' + user.city : ''}` : '—'}</p>
                </div>
              </div>
            </Card>
            ...
            <div className="space-y-3">
              ...
              <Button variant="outline" size="lg" className="w-full gap-2 justify-start text-destructive hover:text-destructive" onClick={() => logout()}>
                <LogOut size={18} />
                Sign Out
              </Button>
            </div>
